...
func renderIndexHtml(events: [Database.Event], user: String) throws -> String {
    let encoder = JSONEncoder()
    func encode_json<T: Encodable>(_ value: T) throws -> String {
    ...
    <html lang="ja">
      ...
      <body>
        <div id="container" class="container">
          <div id="app-wrapper" data-login-user="\(encode_json(user))" data-events="\(encode_json(events))">
